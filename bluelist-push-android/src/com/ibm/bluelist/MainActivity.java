...
public class MainActivity extends Activity {
    ...
    List<String> places;
    public final static String EXTRA_MESSAGE = "com.ibm.bluelist";
	@Override
	/**
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		places = blApplication.getItemList();
		...
		/* Refresh the list. */
		//listItems();
        String[] values = new String[] { "The Greener Side",
                "Aachis-Chettinad Cuisine",
                "Infinitea"
...
*/
        ...
        /*System.out.println("Length"+places1.length);
        for(int i =0;i<places1.length;i++)
        {
            if(places1[i]!=null)
            {
                count++;
                System.out.println("places"+places1[i]);
            }
        }
        finalPlaces = new String[count];
        for(int i =0;i<count;i++)
        {
            if(places1[i]!=null)
            {
                finalPlaces[i] = places1[i];
            }
        }
        for(int i =0;i<count;i++)
        {
            if(places1[i]!=null)
            {
                System.out.println(finalPlaces[i]);
            }
        }*/
        ...
        itemsLV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                String itemValue = (String) itemsLV.getItemAtPosition(position);
                ...
                Intent intent = new Intent(getApplicationContext(), sendTweet.class);
